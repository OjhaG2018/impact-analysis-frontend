          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600">Question</th>
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600">Type</th>
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600">Category</th>
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600">Sensitivity</th>
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600">Required</th>
              ...
              {questions.map((question) => (
                <tr key={question.id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="px-4 py-4 max-w-md">
                    ...
                    >
                      <p className="font-medium text-gray-900 line-clamp-2">{('text' in question) ? question.text : question.question_text}</p>
  ...
  const renderDeleteModal = () => (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex gap-3 pt-4 border-t">
          <Button variant="secondary" onClick={() => { setShowDeleteModal(false); setDeleteTarget(null); }} disabled={deleting}>
            Cancel
          </Button>
          <Button onClick={handleDeleteQuestion} disabled={deleting} className="bg-red-600 hover:bg-red-700">
